namespace SpaceInvaders {
  ...
  export class QuadNode extends f.Node {
    ...
    private static material: f.Material = new f.Material("Material", f.ShaderUniColor, new f.CoatColored());
    private static textureInvader: f.TextureImage = new f.TextureImage("./Assets/Invader.png");
    private static materialInvader: f.Material = new f.Material("Invader", f.ShaderTexture, new f.CoatTextured(f.Color.CSS("White"), QuadNode.textureInvader));
    private static textureMothership: f.TextureImage = new f.TextureImage("./Assets/mothership.png");
    private static materialMothership: f.Material = new f.Material("Invader", f.ShaderTexture, new f.CoatTextured(f.Color.CSS("White"), QuadNode.textureMothership));
    public rect: f.Rectangle;
    constructor(_name: string, _pos: f.Vector2, _scale: f.Vector2, _texture?: string) {
      super(_name);
